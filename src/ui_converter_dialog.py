...
#
# Created: Fri Sep 14 14:31:18 2012
...
class Ui_ConverterDialog(object):
    def setupUi(self, ConverterDialog):
        ...
        ConverterDialog.resize(383, 114)
        ...
        ConverterDialog.setMinimumSize(QtCore.QSize(383, 114))
        ConverterDialog.setMaximumSize(QtCore.QSize(383, 114))
        ...
        self.gridLayout.addWidget(self.chkAddToCanvas, 2, 0, 1, 3)
